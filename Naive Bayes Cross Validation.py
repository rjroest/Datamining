...
from sklearn.naive_bayes import GaussianNB  # Hier importeer ik GaussianNB voor Naive Bayes
import pandas as pd
...
# Create your machine learning model (replace GaussianNB with your chosen model)
model = GaussianNB()  # Hier gebruik ik Gaussian Naive Bayes als voorbeeld
